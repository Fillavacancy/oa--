...
public class SelPersonalbookJsonServlet extends HttpServlet
{
    private static final long serialVersionUID = -2674779048753886974L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        else
        {
            ...
            try
            {
                List list = userMail.infoPersonalbooks(userId);
                if (list.size() > 0)
                {
